...
public class VerticalScroll {
	...
	public void tc_InvokeApp()
	{
		...
		try {
			...
			driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().resourceId(\"android:id/list\")).scrollIntoView(new UiSelector().text(\"WebView\"))")).click();
