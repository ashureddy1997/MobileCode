...
public class DragAndDrop {
	...
	public void tc_InvokeApp()
	{
		...
		try {
			...
			WebElement dragFromcircle= driver.findElement(By.id("com.touchboarder.android.api.demos:id/drag_dot_1"));
			WebElement  dragTocircle= driver.findElement(By.id("com.touchboarder.android.api.demos:id/drag_dot_3"));
