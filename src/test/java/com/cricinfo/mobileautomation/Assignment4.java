...
/*Launch app->Tap on Signup later->Finish->Tap on Score icon->check top events displayed or not*/
import java.net.URL;
...
public class Assignment4 {
    ...
    public void desiredCapabalities()
	{
		...
		Thread.sleep(70000);
		MobileElement oEle1 = driver.findElement(By.xpath("//*[@text='Top Events']"));
		Thread.sleep(10000);
		if(oEle1.isDisplayed()) {
			System.out.println("Top Events Displayed");
		}else {
			System.out.println("Failed to Display Top Events");
		}
